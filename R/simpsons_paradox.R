...
#'
#' In any case, the correlation between the means of each subgroup will
#' be close to \code{r_tot}. If you want to target this correlation
#' directly, use \code{\link{simpsons_mean}}.
#'
#' @examples
#'
